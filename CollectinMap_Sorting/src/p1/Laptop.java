...
// business object 
// Serializable is the marker interface and let you store the obect in HDD along with state and behaviour
...
public class Laptop implements Comparable<Laptop>,Serializable {
	...
	// add comprable interface to provide default sorting behaviour
	@Override
	public int compareTo(Laptop argLaptop) {
		
		
		return argLaptop.id - this.id;
	}
